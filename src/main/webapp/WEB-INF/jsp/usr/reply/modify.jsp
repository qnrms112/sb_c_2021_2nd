      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <th>댓글 번호</th>
            <td>
              <div class="badge badge-secondary">${reply.id}</div>
            </td>
          </tr>
          <tr>
            <th>댓글 작성날짜</th>
          ...
          <tr>
            <th>추천</th>
            <td>
              <span class="badge badge-secondary">${reply.goodreactionPoint}</span>
            </td>
          </tr>
          <tr>
            <th>내용</th>
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-outline btn-secondary" href="${param.replaceUri}">뒤로가기</a>
            </td>
          </tr>
        </tbody>
      </table>

package com.jbg.exam.demo.config;
...
import com.jbg.exam.demo.interceptor.BeforeActionInterceptor;
import com.jbg.exam.demo.interceptor.NeedLoginInterceptor;
import com.jbg.exam.demo.interceptor.NeedLogoutInterceptor;
...
public class MyWebMvcConfigurer implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		ir.addPathPatterns("/usr/reply/wirte");
		ir.addPathPatterns("/usr/reply/doModify");
		ir.addPathPatterns("/usr/reply/doWrite");
		ir.addPathPatterns("/usr/reply/doDelete");
		ir.addPathPatterns("/usr/article/wirte");
